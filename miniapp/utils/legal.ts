...
export const TERMS_SECTIONS: LegalSection[] = [
  ...
  },
  {
    "id": "changes",
    "title": {
      "en": "10. Changes & Contact",
      "zh": "10. 变更与联系"
    },
    "body": [
      {
        "en": "We may update this Agreement; material changes are versioned and shown at next sign-in. Governed by the laws of the People’s Republic of China, operated by Fei Tao. Questions: support@praxys.run.",
        "zh": "我们可更新本协议；重大变更将进行版本管理并在下次登录时提示。受 the People’s Republic of China 法律管辖，由 Fei Tao 运营。如有疑问：support@praxys.run。"
      }
    ]
  }
];
...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  {
    "id": "mainland-china-processing",
    "title": {
      "en": "3. Mainland China Processing & Overseas Recipients",
      "zh": "3. 中国大陆用户处理与境外接收方"
    },
    "body": [
      {
        "en": "Controller/operator: Fei Tao, contactable at support@praxys.run. Core overseas recipient and processor: Microsoft Corporation and the Microsoft affiliates and subprocessors that provide the Azure subscription used by Praxys. Microsoft privacy requests may be submitted at https://aka.ms/privacyresponseother. Praxys remains responsible for responding to your request and coordinating with processors.",
        "zh": "个人信息处理者/运营者：Fei Tao，联系邮箱：support@praxys.run。核心境外接收方和受托处理方：Microsoft Corporation，以及为 Praxys 所用 Azure 订阅提供服务的 Microsoft 关联方和分包处理方。可通过 https://aka.ms/privacyresponseother 向 Microsoft 提交隐私请求；Praxys 仍负责响应您的请求并与受托处理方协调。"
      },
      {
  ...
  },
  {
    "id": "changes-contact",
    "title": {
      "en": "8. Changes & Contact",
      "zh": "8. 变更与联系"
    },
    "body": [
      {
        "en": "Material changes to recipients, destinations, purposes, categories, retention, rights, or legal basis are versioned and presented before the updated processing starts. Operator: Fei Tao. Privacy and rights contact: support@praxys.run.",
        "zh": "如境外接收方、处理地点、目的、信息类别、保存期限、权利方式或处理依据发生重大变化，我们会更新版本，并在新处理开始前向您展示。运营者：Fei Tao。隐私与权利联系邮箱：support@praxys.run。"
      }
    ]
  }
];
