...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    "body": [
      {
        "en": "You can inspect, correct, stop using, withdraw AI permission, delete, and export private plan context in the Plan interface. Request export or deletion of your full account and data anytime at support@praxys.run. Deleting your account removes your synced data and private context.",
        "zh": "您可在计划界面查看、更正、停止使用、撤回 AI 权限、删除和导出私密计划背景信息。您也可随时通过 support@praxys.run 申请导出或删除完整账号与数据。删除账号将移除已同步数据和私密计划背景信息。"
      }
    ]
  }
];
