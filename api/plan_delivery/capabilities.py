...
def garmin_plan_delivery_operator_enabled() -> bool:
    """Return whether this deployment permits experimental Garmin writes."""
...
def experimental_plan_delivery_status(
    ...
    *,
    ...
    available = garmin_plan_delivery_operator_enabled()
    return {
        "garmin": {
            "experimental": True,
            "available": available,
