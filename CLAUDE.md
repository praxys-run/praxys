...
- If automation uses Statsig's official Console API, keep its credentials secret, make changes reviewable and idempotent, and update the operations docs. Never assume an unofficial MCP integration exists.
