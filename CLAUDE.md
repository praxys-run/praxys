...
- **Environment variables** remain deployment-wide infrastructure settings, credentials/secrets, hard prerequisites, and safe fallbacks. **Database state** remains durable consent, authorization, user choice, and product state. Statsig never replaces either layer.
