...
def test_science_research_skill_has_a_discoverable_canonical_workflow() -> None:
    ...
    for requirement in (
        ...
        "Current science approval artifacts remain human-authenticated",
        "activity `avg_power`",
        "science-reviewer",
        ...
        ".github/agents/product-policy.agent.md",
        "schema_version: 2",
        "product_context",
        "product value and representative",
        "implementation impact map, not the\nimplementation itself",
