      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <Button
            ...
            disabled={!adult || !consent || busy || isDemo}
          >
        ...
        <>
          ...
          {available && (
            <Alert className="border-accent-cobalt/40 bg-accent-cobalt/5">
              ...
              <AlertTitle><Trans>Historical association; not predictively validated</Trans></AlertTitle>
              <AlertDescription>
                <Trans>Your descriptive stability checks passed, but the chronological test did not show better future-run prediction. Read the curve only as a pattern in eligible past runs.</Trans>
              </AlertDescription>
            </Alert>
          )}
