...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  { id: "rights", title: { en: "7. Your Rights", zh: "7. 您的权利" }, body: [
    { en: "You may ask Praxys to explain the processing rules; inspect, copy, correct, supplement, restrict, or delete personal information; withdraw optional AI permission; disconnect a provider; export your account data; or delete the account. Use the product controls where available or email " + SUPPORT_EMAIL + ". For information processed by an overseas recipient, contact Praxys through the same channel; Praxys will verify the request and coordinate the response. You may also complain to the competent personal-information protection authority.",
      zh: "您可要求 Praxys 说明处理规则，查阅、复制、更正、补充、限制或删除个人信息，撤回可选 AI 权限，断开平台连接，导出账号数据或删除账号。请优先使用产品内控制；也可发送邮件至 " + SUPPORT_EMAIL + "。对于境外接收方处理的信息，请通过同一渠道联系 Praxys；Praxys 会核验请求并协调响应。您也可向有权个人信息保护主管部门投诉。" },
