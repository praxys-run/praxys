        ...
        {status.cadence.map((day) => {
          ...
          return (
            <button
              ...
              className={`h-12 min-w-0 overflow-hidden rounded-md border p-1 text-left transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring sm:h-[4.6rem] sm:p-2 ${stateClass} ${
            ...
            >
              <span className="flex min-w-0 items-baseline justify-between gap-1">
                <span className="hidden min-w-0 truncate text-[11px] uppercase tracking-wide text-muted-foreground sm:inline">
                  {formatWeekday(day.date, locale)}
                </span>
                <span className="min-w-0 shrink-0 truncate font-data text-[11px] font-semibold text-foreground sm:text-xs">
              ...
              <span className="mt-0.5 hidden truncate text-[11px] font-medium text-muted-foreground sm:block">
                {hasIncluded
                  ? i18n._(msg`Included`)
                  : hasObserved
                    ? i18n._(msg`Observed`)
