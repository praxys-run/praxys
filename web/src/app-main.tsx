...
// kicks in. localStorage is authoritative; without a saved preference, CN
// deployments use Chinese before checking navigator.language and DEFAULT_LOCALE.
// The server-preference case (user changed language on
